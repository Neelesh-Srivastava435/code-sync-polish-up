...
class DashboardController extends Controller
{
    public function getStats(): JsonResponse
    {
        ...
        // Calculate trends
        $currentMonthUsers = Member::whereBetween('created_at', [$currentMonthStart, $now])->count();
        $previousMonthUsers = Member::whereBetween('created_at', [$previousMonthStart, $previousMonthEnd])->count();
