...
import { ChevronLeft, Upload, User, X } from 'lucide-react';
...
const EditUser: React.FC = () => {
  ...
  const { users, error, loading: isUserLoading } = useAppSelector((state) => state.users);
  ...
  return (
    <PermissionWrapper module="users" action="edit">
