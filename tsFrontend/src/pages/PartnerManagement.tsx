                  ...
                  <div className="space-y-4">
                    {selectedPartner.assignedBatches?.map((batch) => {
                      const batchAttendance =
                        selectedPartner.attendance?.[batch] || [];
                      ...
                      return (
                        <div key={batch}>
                          ...
                          <div className="mt-2 text-xs text-gray-500">
                            ...
                            Absent:{" "}
                            {totalSessions - presentSessions - lateCount}
                          </div>
                        </div>
                      );
                    })}
...
const PartnerManagement: React.FC = () => {
  const { partners, loading, error, currentPage, totalPages, perPage } = useAppSelector((state) => state.partner);
